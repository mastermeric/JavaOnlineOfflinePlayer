...
public class loglama {
	...
	public int logYaz(String icerik)
	{
		...
		{
			System.out.println("logYaz icinde HATA ==>>>" + ex.getMessage());
		}

		return 0;
	}

	public int textYaz(String yazilacakDosya, String icerik)
	{
		...
		try
		{
			myFile = new FileWriter(yazilacakDosya,true);
