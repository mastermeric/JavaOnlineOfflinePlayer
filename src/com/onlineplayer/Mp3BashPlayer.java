...
public class Mp3BashPlayer
{
	...
	public void PlayMp3FromBash()
	{
		...
		try
		{
			...
			myLog.logWrite("Startup Licence Situation :");
			myLog.logWrite("Remaining Days : " + String.valueOf(PublicValues.LicenceTimeLeft));
	...
	{
		myLog.logWrite("PlayMp3FromBash() ERROR ==>>> " + ex.getMessage());
		System.exit(0);
	}
  }
